describe('class', () => {
  ...
  it('can use property setters and getters', () => {
    ...
    //       return 'this musician played in ' + this.bands[1] + ', ' + this.bands[2] + ', ' + this.bands[3];
    //     }
    //     if (this.bands.length > 2) {
    //       return 'this musician played in ' + this.bands[1] + ', ' + this.bands[2];
    //     }
    //     if (this.bands.length > 1) {
    //       return 'this musician played in ' + this.bands[1];
    //     }
    //   }
